		...
		<main class="main">
			<form action="SendCon.do" method="post" id="survey-form"
				...
				<div class="progressbar" tabindex="0" role="progressbar"
					...
					<span class="progressbar__step active" aria-hidden="true"></span> <span
				...
				<section class="survey__panel" aria-hidden="true" data-index="2"
					...
					<div class="form-group form-group-textarea">
						...
						<textarea name="send_place" id="recommendation" spellcheck="false"
							placeholder="세부 목적지를 작성해 주세요"></textarea>
					</div>
					<p class="error-message"></p>
				</section>
				<!-- 두번째질문 끝 -->
