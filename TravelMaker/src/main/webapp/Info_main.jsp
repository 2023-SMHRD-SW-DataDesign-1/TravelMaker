    ...
    <div class="untree_co-section">
        <div class="container">
            ...
            <div class="owl-carousel owl-3-slider">
                ...
                <div class="item">
                    <a class="media-thumb" href="img/hero-slider-1.jpg" data-fancybox="gallery">
                        <div class="media-text">
                            <h3>-</h3>
                            <span class="location">-</span>
                        </div>
                        <img src="img/hero-slider-1.jpg" alt="Image" class="img-fluid">
                    </a>
                </div>

                <div class="item">
                    <a class="media-thumb" href="img/hero-slider-2.jpg" data-fancybox="gallery">
                        <div class="media-text">
                            <h3>-</h3>
                            <span class="location">-</span>
                        </div>
                ...
                <div class="item">
                    <a class="media-thumb" href="img/hero-slider-3.jpg" data-fancybox="gallery">
                        <div class="media-text">
                            <h3>-</h3>
                            <span class="location">-</span>
                        </div>
